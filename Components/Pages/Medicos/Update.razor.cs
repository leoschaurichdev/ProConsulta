...
namespace ProConsulta.Components.Pages.Medicos
{
    public class UpdateMedicoPage : ComponentBase
    {
        ...
        [Inject]
        private IMedicoRepository repository { get; set; } = default!;
        ...
        public async Task OnValidSubmitAsync(EditContext editContext)
        {
            try
            {
                ...
                if (editContext.Model is MedicoInputModel model)
                {
                    ...
                    Snackbar.Add($"Médico {CurrentMedico.Nome} atualizado com sucesso!", Severity.Success);
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (CurrentMedico is not null) return;
